...
<div id="page" class="site">
	...
	<header id="masthead" class="site-header">
		...
		<div id = "header">
			<a href = "/"> <img id = "logo" src = "/wp-content/themes/msssv/msssv.jpg"/> </a>
				<nav id="site-navigation" class="main-navigation">
					<button class="menu-toggle" aria-controls="primary-menu" aria-expanded="false"><?php esc_html_e( 'Primary Menu', 'msssv' ); ?></button>
					<?php
						wp_nav_menu( array(
